...
install -Dm 644 $HBB/res/remotend.service -t "%{buildroot}/usr/share/rustdesk/files"
install -Dm 644 $HBB/res/remotend.desktop -t "%{buildroot}/usr/share/rustdesk/files"
install -Dm 644 $HBB/res/remotend-link.desktop -t "%{buildroot}/usr/share/rustdesk/files"
