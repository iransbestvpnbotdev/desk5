...
pub const LINK_DOCS_HOME: &str = "https://jobbusy.com/docs/en/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://jobbusy.com/docs/en/manual/linux/#x11-required";
pub const LINK_HEADLESS_LINUX_SUPPORT: &str =
    "https://github.com/jobbusy/jobbusy/wiki/Headless-Linux-Support";
lazy_static::lazy_static! {
    pub static ref HELPER_URL: HashMap<&'static str, &'static str> = HashMap::from([
        ("jobbusy docs home", LINK_DOCS_HOME),
        ("jobbusy docs x11-required", LINK_DOCS_X11_REQUIRED),
        ("jobbusy x11 headless", LINK_HEADLESS_LINUX_SUPPORT),
        ]);
}
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["remotend.jobbusy.xyz"];
pub const PUBLIC_RS_PUB_KEY: &str = "abiPOtAxjFQc2uE/PD9fgGcrV8zJolG9tJx2l6+kacc=";
