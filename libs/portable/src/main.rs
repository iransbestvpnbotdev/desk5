...
const APP_PREFIX: &str = "remotend";
const APPNAME_RUNTIME_ENV_KEY: &str = "remotend_APPNAME";
...
mod windows {
    ...
    pub const WIN_TOPMOST_INJECTED_PROCESS_EXE: &'static str = "RuntimeBroker_remotend.exe";
    ...
    pub(super) fn copy_runtime_broker(dir: &PathBuf) {
        ...
        let _allow_err = Command::new("taskkill")
            .args(&["/F", "/IM", "RuntimeBroker_remotend.exe"])
