...
def write_metadata(md5_table: dict, output_folder: str, exe: str):
    ...
    with open(output_path, "wb") as f:
        f.write("remotend".encode(encoding=encoding))
...
# Linux: python3 generate.py -f ../remotend-portable-packer/test -o . -e ./test/main.py
# Windows: python3 .\generate.py -f ..\remotend\flutter\build\windows\runner\Debug\ -o . -e ..\remotend\flutter\build\windows\runner\Debug\remotend.exe
