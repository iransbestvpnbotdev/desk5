...
Chattez avec nous : [Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/remotend) | [Reddit](https://www.reddit.com/r/remotend)

[![ko-fi](https://ko-fi.com/img/githubbutton_sm.svg)](https://ko-fi.com/I2I04VU09)

Encore un autre logiciel de bureau à distance, écrit en Rust. Fonctionne directement, aucune configuration n'est nécessaire. Vous avez le contrôle total de vos données, sans aucun souci de sécurité. Vous pouvez utiliser notre serveur de rendez-vous/relais, [configurer le vôtre](https://remotend.com/server), ou [écrire votre propre serveur de rendez-vous/relais](https://github.com/remotend/remotend-server-demo).

remotend accueille les contributions de tout le monde. Voir [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) pour plus d'informations.

[**TÉLÉCHARGEMENT BINAIRE**](https://github.com/remotend/remotend/releases)
...
Veuillez vous assurer que vous exécutez ces commandes à partir de la racine du dépôt remotend, sinon l'application ne pourra pas trouver les ressources requises. Notez également que les autres sous-commandes de cargo telles que `install` ou `run` ne sont pas actuellement supportées par cette méthode car elles installeraient ou exécuteraient le programme à l'intérieur du conteneur au lieu de l'hôte.

## Structure du projet

- **[libs/hbb_common](https://github.com/remotend/remotend/tree/master/libs/hbb_common)** : codec vidéo, config, wrapper tcp/udp, protobuf, fonctions fs pour le transfert de fichiers, et quelques autres fonctions utilitaires.
- **[libs/scrap](https://github.com/remotend/remotend/tree/master/libs/scrap)** : capture d'écran
- **[libs/enigo](https://github.com/remotend/remotend/tree/master/libs/enigo)** : contrôle clavier/souris spécifique à la plate-forme
- **[src/ui](https://github.com/remotend/remotend/tree/master/src/ui)** : interface graphique
- **[src/server](https://github.com/remotend/remotend/tree/master/src/server)** : services audio/clipboard/input/vidéo, et connexions réseau
- **[src/client.rs](https://github.com/remotend/remotend/tree/master/src/client.rs)** : démarrer une connexion entre pairs
- **[src/rendezvous_mediator.rs](https://github.com/remotend/remotend/tree/master/src/rendezvous_mediator.rs)** : Communiquer avec [remotend-server](https://github.com/remotend/remotend-server), attendre une connexion distante directe (TCP hole punching) ou relayée.
- **[src/platform](https://github.com/remotend/remotend/tree/master/src/platform)** : code spécifique à la plateforme
