use libremotend::api::remotendApiTable;
/// This file demonstrates how to write a custom plugin for remotend.
...
lazy_static::lazy_static! {
    ...
    // Do your own logic based on the API provided by remotend.
    pub static ref API: remotendApiTable = remotendApiTable::default();
}
