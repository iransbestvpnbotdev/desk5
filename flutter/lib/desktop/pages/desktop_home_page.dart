...
class _DesktopHomePageState extends State<DesktopHomePage>
  ...
  Future<Widget> buildHelpCards() async {
    if (updateUrl.isNotEmpty && !isCardClosed) {
      return buildInstallCard(
        ...
        final Uri url = Uri.parse('https://remotend.com/download');
        await launchUrl(url);
      }, closeButton: true);
    }
    ...
    if (Platform.isWindows) {
      ...
      if (bind.isSelinuxEnforcing()) {
        ...
        if (bind.mainGetLocalOption(key: keyShowSelinuxHelpTip) != 'N') {
          LinuxCards.add(buildInstallCard(
            ...
            help: 'Help',
            link:
                'https://remotend.com/docs/en/client/linux/#permissions-issue',
            closeButton: true,
      ...
      if (bind.mainCurrentIsWayland()) {
        LinuxCards.add(buildInstallCard(
            ...
            marginTop: LinuxCards.isEmpty ? 20.0 : 5.0,
            help: 'Help',
            link: 'https://remotend.com/docs/en/manual/linux/#x11-required'));
      } else if (bind.mainIsLoginWayland()) {
        LinuxCards.add(buildInstallCard("Warning",
            "Login screen using Wayland is not supported", "", () async {},
            marginTop: LinuxCards.isEmpty ? 20.0 : 5.0,
            help: 'Help',
            link: 'https://remotend.com/docs/en/manual/linux/#login-screen'));
      }
  ...
  void initState() {
    ...
    remotendWinManager.registerActiveWindowListener(onActiveWindowChanged);
    ...
    remotendWinManager.setMethodHandler((call, fromWindowId) async {
      ...
      if (call.method == kWindowMainWindowOnTop) {
        ...
        await remotendWinManager.registerActiveWindow(call.arguments["id"]);
      } else if (call.method == kWindowEventHide) {
        await remotendWinManager.unregisterActiveWindow(call.arguments['id']);
        ...
        if (windowId != null) {
          await remotendWinManager.moveTabToNewWindow(
        ...
        await remotendWinManager.openMonitorSession(
