...
///
/// Note:
/// On linux, we use dbus to communicate multiple remotend process.
...
const DBUS_NAME: &str = "org.remotend.remotend";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "remotend DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.remotend.remotend /dbus org.remotend.remotend.NewConnection string:'PEER_ID'`
