...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Подключение к сети Remotend..."),
        ...
        ("install_tip", "В некоторых случаях из-за UAC Remotend может работать неправильно на удалённом узле. Чтобы избежать UAC, нажмите кнопку ниже для установки Remotend в системе."),
        ...
        ("Configure", "Настроить"),
        ("config_acc", "Чтобы удалённо управлять своим рабочим столом, вы должны предоставить Remotend права \"доступа\""),
        ("config_screen", "Для удалённого доступа к рабочему столу вы должны предоставить Remotend права \"снимок экрана\""),
        ...
        ("android_input_permission_tip1", "Чтобы удалённое устройство могло управлять вашим Android-устройством с помощью мыши или нажатий, необходимо разрешить Remotend использовать службу \"Специальные возможности\"."),
        ("android_input_permission_tip2", "Перейдите на соответствующую страницу системных настроек, найдите и войдите в \"Установленные службы\", включите службу \"Remotend Input\"."),
        ...
        ("Quit", "Выйти"),
        ("doc_mac_permission", "https://Remotend.com/docs/ru/manual/mac/#включение-разрешений"),
        ("Help", "Помощь"),
        ("Failed", "Не выполнено"),
        ("Succeeded", "Выполнено"),
        ...
        ("Language", "Язык"),
        ("Keep Remotend background service", "Держать в фоне службу Remotend"),
        ...
        ("Show Remotend", "Показать Remotend"),
        ...
        ("config_input", "Чтобы управлять удалённым рабочим столом с помощью клавиатуры, необходимо предоставить Remotend разрешения \"Мониторинг ввода\"."),
        ("config_microphone", "Чтобы разговаривать с удалённой стороной, необходимо предоставить Remotend разрешение \"Запись аудио\"."),
        ...
        ("still_click_uac_tip", "По-прежнему требуется, чтобы удалённый пользователь нажал \"OK\" в окне UAC при запуске Remotend."),
        ...
        ("install_cert_tip", "Установить сертификат Remotend"),
        ("confirm_install_cert_tip", "Это тестовый сертификат Remotend, которому можно доверять. Он будет использоваться только по необходимости для установки драйверов Remotend."),
        ...
        ("verify_Remotend_password_tip", "Подтвердить пароль Remotend"),
