...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke jaringan Remotend..."),
        ...
        ("install_tip", "Karena UAC, Remotend tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal Remotend ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Click to download", "Klik untuk unduh"),
        ("Click to update", "Klik untuk memperbarui"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Untuk mengontrol Desktop Anda dari jarak jauh, Anda perlu memberikan izin \"Aksesibilitas\" Remotend."),
        ("config_screen", "Untuk mengakses Desktop Anda dari jarak jauh, Anda perlu memberikan izin \"Perekaman Layar\" Remotend."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android Anda melalui mouse atau sentuhan, Anda harus mengizinkan Remotend untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input Remotend]."),
        ...
        ("Language", "Bahasa"),
        ("Keep Remotend background service", "Pertahankan Remotend berjalan pada service background"),
        ...
        ("Show Remotend", "Tampilkan Remotend"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada Remotend"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada Remotend"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC Remotend yang sedang berjalan"),
        ...
        ("install_cert_tip", "Install sertifikat Remotend"),
        ("confirm_install_cert_tip", "Ini adalah sertifikat pengujian Remotend, yang dapat dipercaya. Sertifikat ini akan digunakan untuk menginstal driver Remotend saat diperlukan"),
        ...
        ("verify_Remotend_password_tip", "Verifikasi Kata Sandi Remotend"),
