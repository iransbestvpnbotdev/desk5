...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till Remotend..."),
        ...
        ("install_tip", "På grund av UAC, kan inte Remotend fungera ordentligt på klientsidan. För att undvika UAC, tryck på knappen nedan för att installera Remotend på systemet."),
        ...
        ("config_acc", "För att kontrollera din dator på distans måste du ge Remotend \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge Remotend \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [Remotend Input] tjänsten."),
        ...
        ("Language", "Språk"),
        ("Keep Remotend background service", "Behåll Remotend i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa Remotend programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ("Start on Boot", ""),
