...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "remotendi võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa remotend mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et remotend oma süsteemi paigaldada."),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb remotendile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb remotendile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma remotendile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [remotend Input] sisse."),
        ...
        ("doc_mac_permission", "https://remotend.com/docs/en/manual/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele remotendi rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma remotendile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma remotendile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud remotendi kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("install_cert_tip", "Paigalda remotend sertifikaat"),
        ("confirm_install_cert_tip", "See on remotendi testimise sertifikaat, mida võib usaldada. Sertifikaati kasutatakse vajadusel remotendi draiverite usaldamiseks ja paigaldamiseks."),
        ...
        ("verify_remotend_password_tip", "Kinnita remotendi parooli"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul remotendi kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_remotend_server_pro_to_{}_tip", "Palun täienda remotend Server Pro versioonile {} või uuem!"),
        ("pull_group_failed_tip", "Grupi värskendamine ebaõnnestus"),
        ("doc_fix_wayland", "https://remotend.com/docs/en/manual/linux/#x11-required"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib remotendil takistada juhitud poolel toimimist."),
