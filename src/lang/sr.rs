...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na Remotend mrežu..."),
        ...
        ("install_tip", "Zbog UAC Remotend ne može raditi pravilno u nekim slučajevima. Da biste prevazišli UAC, kliknite taster ispod da instalirate Remotend na sistem."),
        ...
        ("config_acc", "Da biste daljinski kontrolisali radnu površinu, Remotend-u treba da dodelite \"Accessibility\" prava."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, Remotend-u treba da dodelite \"Screen Recording\" prava."),
        ...
        ("android_input_permission_tip1", "Da bi daljinski uređaj kontrolisao vaš Android uređaj preko miša ili na dodir, treba da dozvolite Remotend-u da koristi \"Accessibility\" servis."),
        ("android_input_permission_tip2", "Molimo pređite na sledeću stranicu sistemskih podešavanja, pronađite i unesite [Installed Services], uključite [Remotend Input] servis."),
        ...
        ("Language", "Jezik"),
        ("Keep Remotend background service", "Zadrži Remotend kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite da onemogućite ovu funkciju, molimo idite na sledeću stranicu za podešavanje Remotend aplikacije, pronađite i uđite u [Battery], isključite [Unrestricted]"),
        ("Start on Boot", ""),
        ...
        ("Show Remotend", "Prikazi Remotend"),
        ("This PC", "Ovaj PC"),
        ("or", "ili"),
