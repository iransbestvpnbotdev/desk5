...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, Remotend bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, Remotend'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ...
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için Remotend'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için Remotend'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, Remotend'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [Remotend Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep Remotend background service", "Remotend arka plan hizmetini sürdürün"),
        ...
        ("Show Remotend", "Remotend'i Göster"),
        ("This PC", "Bu PC"),
        ("or", "veya"),
