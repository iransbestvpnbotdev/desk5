...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua Remotend..."),
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca Remotend să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala Remotend."),
        ...
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți Remotend acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți Remotend acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți Remotend să utilize serviciul „Accesibilitate”."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [Remotend Input]."),
        ...
        ("Language", "Limbă"),
        ("Keep Remotend background service", "Rulează serviciul Remotend în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației Remotend, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("Show Remotend", "Afișează Remotend"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("config_input", "Pentru a controla desktopul la distanță folosind tastatura, trebuie să acorzi Remotend permisiunea Monitorizare intrare"),
        ("config_microphone", "Pentru a desfășura un apel vocal, este nevoie să acorzi Remotend permisiunea Înregistrare audio."),
        ...
        ("still_click_uac_tip", "Este necesar ca utilizatorul la distanță să confirme în fereastra CCU din Remotend care rulează."),
        ...
        ("install_cert_tip", "Instalează certificatul Remotend"),
        ("confirm_install_cert_tip", "Acesta este un certificat de testare Remotend și este de încredere. Certificatul va fi utilizat pentru a acorda încredere și instala drivere Remotend atunci când este necesar."),
        ...
        ("verify_Remotend_password_tip", "Verifică parola Remotend"),
