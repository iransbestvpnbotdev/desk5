...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Remotend może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować Remotend w swoim systemie."),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić Remotend na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [Remotend Input]."),
        ...
        ("Language", "Język"),
        ("Keep Remotend background service", "Zachowaj usługę Remotend w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji Remotend, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji Remotend uprawnień do \"Urządzeń Wejściowych\"."),
        ...
        ("install_cert_tip", "Instalacja certyfikatu Remotend"),
        ("confirm_install_cert_tip", "To jest certyfikat testowy Remotend, któremu można zaufać. Certyfikat jest używany do zaufania i instalowania sterowników Remotend w razie potrzeby."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z Remotend w Twojej sieci."),
        ...
        ("verify_Remotend_password_tip", "Weryfikuj hasło Remotend"),
